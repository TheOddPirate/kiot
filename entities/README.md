...
- Automatic attribute conversion for Home Assistant compatibility
...
- Use efficient data conversion methods
- Avoid frequent state updates for static data
...
| Notify | notify | message reception |
