...
/**
 * @file textbox.h
 * @brief Textbox entity for Home Assistant integration
 * 
 * @details
 * This header defines the Textbox class which implements a textbox entity
 * for Home Assistant. Textbox entities provide a text input interface for
 * entering and editing string values, with bidirectional text synchronization
 * between KIOT and Home Assistant.
 * 
 * The textbox entity is commonly used for script argument input, custom
...
/**
 * @class Textbox
 * @brief Textbox entity for text input and editing
 * 
 * @details
 * The Textbox class represents a textbox entity in Home Assistant, used for
...
public:
    /**
     * @brief Constructs a Textbox entity
     * @param parent Parent QObject for memory management (optional)
     */
    explicit Textbox(QObject *parent = nullptr);
    
    /**
     * @brief Initializes the textbox entity
     * 
     * @details
     * Overrides Entity::init() to set up textbox-specific configuration,
...
Q_SIGNALS:
     ...
     * @code
     * connect(textbox, &Textbox::stateChangeRequested, [](const QString &arg) {
