 ...
 */
class DisplayManager : public QObject, public KIOTShared::Plugins::KIOTPluginInterface {
    Q_OBJECT
...
public:
    ...
    /**
     * @brief Destroys the DisplayManager instance and ensures safe resource cleanup.
     */
