 ...
 */
class AppLauncherPlugin : public QObject, public KIOTShared::Plugins::KIOTPluginInterface {
    Q_OBJECT
...
public:
    /**
     * @brief Constructs a AppLauncherPlugin instance.
     * @param parent Optional parent QObject.
     */
    explicit AppLauncherPlugin(QObject *parent = nullptr);

    /**
     * @brief Destroys the AppLauncherPlugin instance and ensures safe resource cleanup.
     */
    ~AppLauncherPlugin() override;
