...
QML_ELEMENT
KMPRIS_EXPORT Q_NAMESPACE enum Status : std::uint32_t {
    Unknown = 0,
    None,
    Playlist,
    Track,
...
protected:
    ...
    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(AbstractPlayerContainer, LoopStatus::Status, m_loopStatus, LoopStatus::Unknown, &AbstractPlayerContainer::loopStatusChanged)
    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(AbstractPlayerContainer, ShuffleStatus::Status, m_shuffle, ShuffleStatus::Unknown, &AbstractPlayerContainer::shuffleChanged)
    ...
    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(AbstractPlayerContainer, PlaybackStatus::Status, m_playbackStatus, PlaybackStatus::Unknown, &AbstractPlayerContainer::playbackStatusChanged)
