 ...
 */
class SystemdPlugin : public QObject, public KIOTShared::Plugins::KIOTPluginInterface {
    Q_OBJECT
...
public:
    /**
     * @brief Constructs a SystemdPlugin instance.
     * @param parent Optional parent QObject.
     */
    explicit SystemdPlugin(QObject *parent = nullptr);

    /**
     * @brief Destroys the SystemdPlugin instance and ensures safe resource cleanup.
     */
    ~SystemdPlugin() override;
...
private:
    SystemDWatcher *m_watcher = nullptr;
};