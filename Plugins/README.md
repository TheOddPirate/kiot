...
Welcome to the Plugins folder! =)

Here you will find each of the plugins that Kiot supports. Each plugin is a separate folder, the documentation will be updated later on for each plugin.
